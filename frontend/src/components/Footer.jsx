...
const Footer = () => {
  return (
    <footer className="bg-[var(--footer-bg)] text-[var(--primary)] overflow-hidden relative border-t border-gray-200">
      ...
      {/* 🔹 TOP SECTION (LIGHT) */}
      <div className="w-[90%] max-w-7xl mx-auto pt-0 pb-2 relative z-10">
      ...
      <div className="bg-[var(--primary)] text-white py-6 relative overflow-hidden">
        ...
        <div className="w-[90%] max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col gap-6">
            ...
            {/* 🔹 FOOTER STATEMENT */}
            <div className="pb-1">
              <p className="text-lg md:text-xl text-white/90 font-serif tracking-wide text-center max-w-3xl mx-auto leading-relaxed px-4">
            ...
            {/* 🔹 BOTTOM BAR */}
            <div className="pt-3 border-t border-white/10 flex flex-col md:flex-row justify-between items-center text-[10px] text-white/40 font-bold uppercase tracking-[0.2em] gap-3">
